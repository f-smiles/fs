  ...
  const setPath = (progress) => {
    ...
    if (container.current) {
      ...
      path.current.setAttributeNS(
        null,
        "d",
        `M 0 10 Q${width * x} ${10 + progress} ${width} 10`
      )
    }
  }
  ...
  return (
    <div ref={container} className="col-span-12 row-start-2 h-[1px] w-full relative">
      <div
        ...
        className="relative -top-[-5px] h-[10px] z-10 hover:-top-[10px] hover:h-[40px]"
      />
      <svg className="absolute -top-[10px] w-full h-[40px] text-zinc-300 dark:text-zinc-600">
